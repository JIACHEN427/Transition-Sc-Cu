...
save
      ...
      !Advection scheme
      integer :: iadv_mom = 5, iadv_tke = -1, iadv_thl = -1,iadv_qt = -1,iadv_sv(100) = -1,iadv_sc(100) = -1
      ...
      real,allocatable :: dsv(:),dsc(:)          !<     * applied gradient of sv(n) at top of model
  ...
  subroutine initglobal
    ...
    if (courant<0) then
      ...
      elseif (any(iadv_sv(1:nsv)==iadv_hybrid ).or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_hybrid)) then
       ...
       if (any(iadv_sc(1:nsc)==iadv_cd6) .or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_cd6)) then
         courant = min(courant, 0.7)
       elseif (any(iadv_sc(1:nsc)==iadv_62) .or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_62)) then
         courant = min(courant, 0.7)
       elseif (any(iadv_sc(1:nsc)==iadv_kappa) .or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_kappa)) then
         courant = min(courant, 0.7)
       elseif (any(iadv_sc(1:nsc)==iadv_5th) .or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_5th)) then
         courant = min(courant, 1.0)
       elseif (any(iadv_sc(1:nsc)==iadv_52 ).or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_52)) then
         courant = min(courant, 1.0)
       elseif (any(iadv_sc(1:nsc)==iadv_cd2) .or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_cd2)) then
         courant = min(courant, 1.0)
       elseif (any(iadv_sc(1:nsc)==iadv_hybrid ).or. any((/iadv_thl,iadv_qt,iadv_tke/)==iadv_hybrid)) then
         courant = min(courant, 1.0)
       end if
    ...
    ncosv = max(2*nsv-3,0)
     ...
     if     (any(advarr==iadv_cd6).or.any(iadv_sc(1:nsc)==iadv_cd6)) then
       ih = 3
       jh = 3
       kh = 1
     elseif (any(advarr==iadv_62).or.any(iadv_sc(1:nsc)==iadv_62)) then
       ih = 3
       jh = 3
       kh = 1
     elseif (any(advarr==iadv_5th).or.any(iadv_sc(1:nsc)==iadv_5th)) then
       ih = 3
       jh = 3
       kh = 1
     elseif (any(advarr==iadv_52).or.any(iadv_sc(1:nsc)==iadv_52)) then
       ih = 3
       jh = 3
       kh = 1
     elseif (any(advarr==iadv_hybrid).or.any(iadv_sc(1:nsc)==iadv_hybrid)) then
       ih = 3
       jh = 3
       kh = 1
     elseif (any(advarr==iadv_hybrid_f).or.any(iadv_sc(1:nsc)==iadv_hybrid_f)) then
       ih = 3
       jh = 3
       kh = 1
     elseif (any(advarr==iadv_kappa).or.any(iadv_sc(1:nsc)==iadv_kappa)) then
       ih = 2
       jh = 2
       kh = 1
     elseif (any(advarr==iadv_cd2).or.any(iadv_sc(1:nsc)==iadv_cd2)) then
       ih = 1
       jh = 1
       kh = 1
     end if
