...
SAVE
  ...
  real, allocatable :: scflux  (:,:,:)  !<  Kinematic passice sclar flux
  ...
  real, allocatable :: scs   (:)        !<  Surface passive scalar concentartion [-]
  ...
  real              :: wscsurf(100) = 0 !<  Prescribed surface scalar(n) flux [- m/s]
  ...
  real              :: wsc_land(100,max_lands)     = -1 !< Prescribed surface scalar(n) flux [- m/s]
  ...
  real, allocatable :: wsc_patch(:,:,:)                 !< Prescribed surface scalar(n) flux [- m/s]
